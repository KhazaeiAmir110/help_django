...
from comment.utils import is_comment_admin, is_comment_moderator, can_block_user, \
...
class ObjectLevelMixin(BaseCommentPermission):
    ...
    def get_object(self):
        raise ImproperlyConfigured(
            ErrorMessage.METHOD_NOT_IMPLEMENTED.format(class_name=self.__class__.__name__,
