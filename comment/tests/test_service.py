...
class TestDABEmailService(BaseAnonymousCommentTest):
    ...
    def test_get_message_templates_text_only(self):
        ...
        text_msg, html_msg = email_service.get_message_templates(text_template, html_template,
                                                                 context)
    ...
    def test_get_message_templates_with_html(self):
        ...
        text_template = 'comment/anonymous/confirmation_request.txt'
        html_template = 'comment/anonymous/confirmation_request.html'
        text_msg, html_msg = self.email_service.get_message_templates(text_template, html_template,
                                                                      context)
    ...
    def test_send_messages(self):
        ...
        messages = [
            self.email_service.get_message('test subject', 'test body', ['test@test'],
                                           html_msg='test msg')
            for _ in range(100)
        ]
