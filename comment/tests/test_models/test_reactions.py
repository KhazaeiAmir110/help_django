...
class ReactionInstanceModelTest(BaseCommentManagerTest):
    ...
    def test_unique_togetherness_of_user_and_reaction_type(self):
        ...
        self.assertRaises(IntegrityError, self.create_reaction_instance, self.user, self.comment,
                          self.DISLIKE)
    ...
    def test_set_reaction_on_incorrect_reaction(self):
        ...
        self.assertRaises(ValidationError, self.set_reaction, self.user_1, self.child_comment_5,
                          'likes')
