...
urlpatterns = [
    ...
    path('comments/<int:pk>/react/<str:reaction>/', views.CommentDetailForReaction.as_view(),
         name='react'),
    ...
    re_path(r'^comments/confirm/(?P<key>[^/]+)/$', views.ConfirmComment.as_view(),
            name='confirm-comment'),
    path('comments/toggle-subscription/', views.ToggleFollowAPI.as_view(),
